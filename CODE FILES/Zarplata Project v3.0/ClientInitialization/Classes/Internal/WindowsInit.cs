...
{
    internal class WindowsInit : Init
    {
        public WindowsInit(IEnumerable<string> appParams, Client client, PrintMessage printMessageMethods, Platform OSPlatform = Platform.Windows, string OSPlatformText = nameof(Platform.Windows)) : base(appParams, client, printMessageMethods, OSPlatform, OSPlatformText)
        {
        }
